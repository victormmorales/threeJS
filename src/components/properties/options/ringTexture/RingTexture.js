...
import { OptionEngravingContainer, OptionEngravingDetail } from './RingTexute.elements';
import * as THREE from 'three';

const RingTexture = ({ setCurrentRingTexture }) => {
    const handleRingTextures = (folder) => {
        ...
        setCurrentRingTexture({
            ...
            roughness: textureLoader.load(`./model/textures/${folder}/roughness_metalness.png`),
        })
    };
